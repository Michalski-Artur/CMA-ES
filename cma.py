...
from vector_initializer import VectorInitializer, ZeroInitializer
...
# Based on CyberAgentAILab implementation: https://github.com/CyberAgentAILab/cmaes
class CMA:
    ...
    def __init__(
        ...
        vector_initializer: VectorInitializer = ZeroInitializer
    ):
